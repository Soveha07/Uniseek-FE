...
const UniversityList: React.FC = () => {
    ...
    useEffect(() => {
        ...
        let universitiesData = location.state?.universities;

        if (!universitiesData) {
            const storedData = localStorage.getItem("universities");
            universitiesData = storedData ? JSON.parse(storedData) : [];
        }
        ...
        if (Array.isArray(universitiesData) && universitiesData.length > 0) {
            ...
            setError("No universities found. Please complete the survey.");
        }
            ...
            <div className="w-full max-w-lg md:w-full md:max-w-none">
                ...
                <div className="md:w-full">
                    <h2 className="text-b1 font-bold my-1 text-center md:text-2xl md:my-6">
                        Here are the top 5 universities that match your response
                    </h2>
