...
import { UniversityMajor } from '../../services/uni/GetUniById';
...
const UniversityAdditionalInfo: React.FC<UniversityAdditionalInfoProps> = ({
  ...
  return (
    <div className="lg:col-span-3 p-6 rounded-xl shadow-md transition-all hover:shadow-lg border border-gray-200">
